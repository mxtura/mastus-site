...
export default function ColorVariant2() {
  ...
  useEffect(() => {
    setIsVisible(true);
    // Загружаем Google Fonts для варианта 2 - гибридный стиль
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FFFFFF', fontFamily: 'Roboto, sans-serif' }}>
      {/* Navigation */}
      <nav className="border-b" style={{ backgroundColor: '#ffffff', borderBottomColor: '#9d171e' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/color-tests/variant-1" className="hover:underline" style={{ color: '#000000' }}>Вариант 1</Link>
              <Link href="/color-tests/variant-2" className="hover:underline font-semibold" style={{ color: '#9d171e' }}>Вариант 2</Link>
      ...
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 overflow-hidden bg-white border-b-2" style={{ borderBottomColor: '#9d171e' }}>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#000000', fontFamily: 'Roboto Slab, serif', letterSpacing: '-0.02em' }}>
              ООО ФИРМА&quot;МАСТУС&quot;
            </h1>
            <p className="text-lg sm:text-xl mb-2 font-semibold" style={{ color: '#9d171e', fontFamily: 'Roboto Slab, serif' }}>
              Вариант 2: Гибридный и технологичный
            </p>
            <p className="text-base mb-8" style={{ color: '#000000' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="w-full sm:w-auto border-2 shadow-sm transition-all font-semibold"
                style={{ borderColor: '#f9a31a', color: '#f9a31a' }}
              >
                Контакты
              </Button>
            </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-8" style={{ color: '#9d171e', fontFamily: 'Roboto Slab, serif', letterSpacing: '-0.01em' }}>
            Цветовая палитра - Вариант 2
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-semibold" style={{ color: '#000000' }}>Вторичный</p>
          ...
          <div className="mt-12 text-center">
            <h3 className="text-xl font-semibold mb-4" style={{ color: '#9d171e', fontFamily: 'Roboto Slab, serif' }}>Типографика</h3>
            <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="bg-white p-4 rounded-lg shadow-sm border">
                <h4 className="font-semibold mb-2" style={{ fontFamily: 'Roboto Slab, serif', color: '#000000' }}>Заголовки</h4>
                <p className="text-sm text-gray-600">Roboto Slab</p>
                <p className="text-xs text-gray-500">Механистический slab serif</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border">
                <h4 className="font-semibold mb-2" style={{ fontFamily: 'Roboto, sans-serif', color: '#000000' }}>Основной текст</h4>
                <p className="text-sm text-gray-600">Roboto</p>
                <p className="text-xs text-gray-500">Неогротеск для читаемости</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16" style={{ backgroundColor: '#F5F5F5' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4" style={{ color: '#9d171e' }}>
              Наша продукция
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Card className="overflow-hidden shadow-sm hover:shadow-md transition-all bg-white border">
              <div className="h-40 flex items-center justify-center" style={{ backgroundColor: '#F5F5F5' }}>
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="text-xs" style={{ backgroundColor: '#9d171e', color: 'white' }}>1-3 секции</Badge>
                </div>
              </div>
            ...
            <Card className="overflow-hidden shadow-sm hover:shadow-md transition-all bg-white border">
              <div className="h-40 flex items-center justify-center" style={{ backgroundColor: '#F5F5F5' }}>
                <div className="text-center">
                  ...
                  <Badge variant="secondary" className="text-xs" style={{ backgroundColor: '#f9a31a', color: 'black' }}>Люки и кольца</Badge>
                </div>
              </div>
              <CardHeader className="pb-2">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-semibold mb-4" style={{ color: '#000000' }}>Получить консультацию</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <Button 
              className="w-full sm:w-auto text-white font-medium px-6 py-2"
              style={{ backgroundColor: '#9d171e' }}
            >
              Заказать звонок
            </Button>
