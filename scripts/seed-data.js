...
async function seedProducts() {
  ...
  const products = [
    ...
    // Лестницы
    {
      name: 'Алюминиевая трехсекционная универсальная лестница 3х12',
      description: 'Профессиональная трехсекционная лестница из алюминия. Может использоваться как приставная, стремянка или выдвижная лестница.',
      category: 'LADDERS',
      size: 'Высота: 3.45м (приставная), 2.44м (стремянка), 6.27м (выдвижная)',
      thickness: 'Профиль 40x20 мм',
      weight: '16 кг',
      load: '150 кг',
      material: 'Алюминиевый сплав АД31',
      color: 'Серебристый алюминий',
      advantages: [
        'Три способа использования в одной лестнице',
        'Легкий вес и высокая прочность',
        'Устойчивые широкие ступени',
      ...
      price: 12500.00,
      images: [
        '/images/products/ladder-3x12-1.jpg',
        '/images/products/ladder-3x12-2.jpg'
      ],
      isActive: true
    },
    {
      name: 'Алюминиевая двухсекционная универсальная лестница 2х10',
      description: 'Универсальная двухсекционная лестница из алюминия. Может использоваться как приставная лестница или стремянка.',
      category: 'LADDERS',
      size: 'Высота: 2.78м (приставная), 2.44м (стремянка)',
      thickness: 'Профиль 38x20 мм',
      weight: '11 кг',
      load: '150 кг',
      material: 'Алюминиевый сплав АД31',
      color: 'Серебристый алюминий',
      advantages: [
        ...
        'Оптимальное соотношение высоты и веса',
        'Надежные замки-фиксаторы',
      ...
      applications: [
        'Ремонтные работы',
        'Покраска и отделка',
        'Уборка высоких помещений',
        'Домашнее хозяйство'
      ],
      price: 8900.00,
      images: [
        '/images/products/ladder-2x10-1.jpg',
        '/images/products/ladder-2x10-2.jpg'
      ],
      isActive: true
    },
    {
      name: 'Алюминиевая односекционная приставная лестница 1х14',
      description: 'Прочная односекционная приставная лестница из алюминия. Идеальна для постоянных рабочих мест и складских помещений.',
      category: 'LADDERS',
      size: 'Высота: 4.06м',
      thickness: 'Профиль 40x20 мм',
      weight: '9 кг',
      ...
      color: 'Серебристый алюминий',
      advantages: [
        'Максимальная высота при минимальном весе',
        'Прочная цельная конструкция',
        'Широкие удобные ступени',
      ...
      price: 6200.00,
      images: [
        '/images/products/ladder-1x14-1.jpg',
        '/images/products/ladder-1x14-2.jpg'
      ],
      isActive: true
    }
  ]
